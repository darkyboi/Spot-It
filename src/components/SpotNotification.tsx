...
const SpotNotification: React.FC<SpotNotificationProps> = ({ 
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 sm:bottom-10 z-40 px-4 pb-6 animate-slide-up">
      <div className="max-w-lg mx-auto glass-morphism rounded-2xl overflow-hidden shadow-lg">
        {/* Header */}
        <div className="px-5 py-4 flex items-center justify-between border-b border-gray-200">
          <div className="flex items-center space-x-3">
            <div className="bg-spot-blue/10 p-2 rounded-full">
              <MapPin className="text-spot-blue" size={18} />
            </div>
            <h3 className="font-medium">You found a Spot!</h3>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-5">
          ...
          <div className="bg-white/50 rounded-xl p-4 mb-4">
            <p className="text-gray-800">{spot.message}</p>
          </div>
